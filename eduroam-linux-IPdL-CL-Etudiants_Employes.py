...
Messages.user_cert_missing = "fichier de certificat personnel non " \
    "trouvé"
Config.instname = "Institut Polytechnique de Lyon - CPE Lyon"
Config.profilename = "Etudiants/Employés"
Config.url = "https://prod.e-campus.cpe.fr/course/view.php?id=14"
Config.email = "support@cpe.fr"
Config.title = "eduroam CAT"
Config.server_match = "cpe.fr"
...
Config.init_confirmation = "Cet installateur ne fonctionnera " \
    ...
    "{1}."
Config.user_realm = "cpe.fr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:rad01.cpe.fr', 'DNS:rad02.cpe.fr', 'DNS:radius.cpe.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@cpe.fr"
Config.tou = ""
